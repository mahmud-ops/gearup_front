        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 bg-muted/50 rounded-lg border text-sm space-y-1">
            <p className="text-muted-foreground">
              <span className="font-semibold text-foreground">Gear:</span> Mountain Bike
            </p>
            <p className="text-muted-foreground">
              <span className="font-semibold text-foreground">Price:</span> $35/day
            </p>
          </div>
          ...
          <div className="p-4 bg-muted/60 rounded-lg border text-sm space-y-1 select-none pointer-events-none opacity-60">
            ...
            <p className="text-muted-foreground">
              Estimated Cost: <span className="font-bold text-foreground">$0</span>
            </p>
          </div>
